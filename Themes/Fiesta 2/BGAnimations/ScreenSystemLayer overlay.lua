...
local function PlayerName( Player )
	local t = Def.ActorFrame {};
		...
		t[#t+1] = LoadActor( THEME:GetPathG("","ScreenSystemLayer/Titles Backgrounds/0 - Default") )..{
			Name = "Back1";
		...
		t[#t+1] = Def.Sprite {
			Name = "Title";
			Texture = THEME:GetPathG("","ScreenSystemLayer/Titles/Beginner/Beginner P1");
			InitCommand=cmd(basezoom,.46;);
		};
...
t[#t+1] = PlayerName( PLAYER_1 )..{
	...
	PlayerStartedSelectProfileMessageCommand=function( self, params )
		...
		if (params.Player == PLAYER_1) then
			...
			title:Load(THEME:GetPathG("","ScreenSystemLayer/Titles/Beginner/Beginner P1.png"));
			title:basezoom(.46);

			local Back1 = self:GetChild("Back1");
			-- Back1:Load(THEME:GetPathG("","ScreenSystemLayer/_PlayerName background"));
			Back1:Load(THEME:GetPathG("","ScreenSystemLayer/Titles Backgrounds/0 - Default"));
	...
	LocalProfileChangeMessageCommand=function(self,params)	--cambio la profile del jugador
		if params.pn=='PlayerNumber_P1' then
			...
			local title = self:GetChild("Title");
			if FILEMAN:GetFileSizeBytes(PROFILEMAN:LocalProfileIDToDir(ProfileID).."/Title P1.png") > 316 then
				title:Load(PROFILEMAN:LocalProfileIDToDir(ProfileID).."/Title P1.png");
			else
				title:Load(THEME:GetPathG("","ScreenSystemLayer/Titles/Beginner/Beginner P1.png"));
			end;
			title:basezoom(.46);
			...
			local Back1 = self:GetChild("Back1");
			if FILEMAN:GetFileSizeBytes(PROFILEMAN:LocalProfileIDToDir(ProfileID).."/Background.png") > 316 then
				Back1:Load(PROFILEMAN:LocalProfileIDToDir(ProfileID).."/Background.png");
			else
				-- Back1:Load(THEME:GetPathG("","ScreenSystemLayer/_PlayerName background"));
				Back1:Load(THEME:GetPathG("","ScreenSystemLayer/Titles Backgrounds/0 - Default"));
			end;
...
t[#t+1] = PlayerName( PLAYER_2 ) .. {
	...
	PlayerStartedSelectProfileMessageCommand=function( self, params )
		if (params.Player == PLAYER_2) then
			...
			local title = self:GetChild("Title");
			title:Load(THEME:GetPathG("","ScreenSystemLayer/Titles/Beginner/Beginner P2.png"));
			title:rotationy(180);
			title:basezoom(.46);
	...
	LocalProfileChangeMessageCommand=function(self,params)	--cambio la profile del jugador
		if params.pn=='PlayerNumber_P2' then
			...
			local title = self:GetChild("Title");
			if FILEMAN:GetFileSizeBytes(PROFILEMAN:LocalProfileIDToDir(ProfileID).."/Title P2.png") > 316 then
				title:Load(PROFILEMAN:LocalProfileIDToDir(ProfileID).."/Title P2.png");
			else
				title:Load(THEME:GetPathG("","ScreenSystemLayer/Titles/Beginner/Beginner P2.png"));
			end;
			title:rotationy(180);
