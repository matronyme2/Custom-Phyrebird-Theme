...
local function PlayerName( Player )
	local t = Def.ActorFrame {};
		...
		t[#t+1] = Def.Sprite {
			Name = "Title";
			Texture = THEME:GetPathG("","ScreenSystemLayer/Titles/Default");
...
t[#t+1] = PlayerName( PLAYER_1 )..{
	...
	PlayerStartedSelectProfileMessageCommand=function( self, params )
		...
		if (params.Player == PLAYER_1) then
			...
			title:Load(THEME:GetPathG("","ScreenSystemLayer/Titles/DefaultP1.png"));
			title:basezoom(.46);
...
t[#t+1] = PlayerName( PLAYER_2 ) .. {
	...
	PlayerStartedSelectProfileMessageCommand=function( self, params )
		if (params.Player == PLAYER_2) then
			...
			local title = self:GetChild("Title");
			title:Load(THEME:GetPathG("","ScreenSystemLayer/Titles/DefaultP2.png"));
			title:rotationy(180);
			title:basezoom(.46);
